...
public class Menu {
    ...
    /**
     * Variable encargada de llamar al objeto listas que contiene todas las
     * listas (usuarios, vehiculos y facturas)
     */
    Listas listas;
    /**
    ...
    /**
     * metodo sin retorno usado para inicializar la lista de vehiculos, facturas
     * y usuarios y enviar al main para ejecutar el programa
     */
    public void iniciar() {
    ...
    /**
     * metodo sin retorno usado para agregar por defecto dos empleados del
     * concesionario a la lista de usuarios
     */
    ...
    /**
     * metodo sin retorno usado para dejar por defecto carros en la lista de
     * vehiculos
     */
    ...
    public void principal(Listas listas) {
        ...
        do {
            ...
            System.out.println("5. Ventas por Referencia");
    ...
    /**
     * metodo sin retorno usado para saber cual es el vehiculo mas vendido he
     * imprimir el reporte
     */
    ...
    /**
     * metodo sin retorno usado para saber cual es el vehiculo menos vendido he
     * imprimir el reporte
     */
    ...
    /**
     *Metodo sin retorno utilizado para saber las ventas por Referencia
     *Reporte
     */
    public void ventaReferencia() {
        System.out.println("Listado de ventas por Referencias");
        for (int i = 0; i < listas.facturas.size(); i++) {
            System.out.println(i + ". Marca: " + listas.vehiculos.get(listas.facturas.get(i).numeroVehiculo).marca
                    + ", Referencia: " + listas.vehiculos.get(listas.facturas.get(i).numeroVehiculo).referencia);
